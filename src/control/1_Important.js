...
function Important () {
    ...
    const handleSubmit = () => {
            fetch(`http://kiisenglish.php.xdomain.jp/z2214505.php?step=controlImportant&userId=${data.userId}&wordId=${data.words[now].wordId}&newImportant=${!important?1:0}`, { method: 'GET', mode: "no-cors" })
            .then(() => {
